...
namespace holoscan::doc::OrsiFormatConverterOp {

PYDOC(OrsiFormatConverterOp, R"doc(
Format conversion operator.
)doc")

// PyOrsiFormatConverterOp Constructor
PYDOC(OrsiFormatConverterOp_python, R"doc(
Format conversion operator.
